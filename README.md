...
`submission.xlsx` with `candidate_id`, `rank`, `score`, and a short recruiter-style
...
- `submission.xlsx` — the final output: 100 ranked candidates with scores and
...
above) and writes `submission.xlsx` alongside it. On the full ~100k-candidate
